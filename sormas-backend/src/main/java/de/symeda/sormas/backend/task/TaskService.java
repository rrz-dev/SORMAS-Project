...
public class TaskService extends AbstractAdoService<Task> {
	...
	public User getTaskAssignee(Contact contact) throws TaskCreationException {
		...
		if (contact.getContactOfficer() != null) {
			...
			if (officers.isEmpty() && contact.getPerson().getMainAddress() != null && contact.getPerson().getMainAddress().getDistrict() != null) {
		...
		if (assignee == null) {
			...
			if (supervisors.isEmpty() && contact.getPerson().getMainAddress() != null && contact.getPerson().getMainAddress().getRegion() != null) {
